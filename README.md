...
## Pipe
- Una Pipe è una funzione che trasforma il valore di un'espressione da un template. 
- Le Pipe sono utilizzate per formattare i dati visualizzati nell'interfaccia utente in modo leggibile e significativo.
- Le Pipe possono essere utilizzate per formattare le stringhe, le date, i numeri e persino per creare filtri personalizzati.
